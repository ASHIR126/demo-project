...
const Home = () => {
    return (
        <>
                            ...
                            <div className="col-md-12">
                                ...
                                <nav id="primary-nav" className="dropdown cf">
                                    <ul className="dropdown menu">
                                        ...
                                        <li><a className="scrollTo" data-scrollto="blog" href="#">Blog Entries</a></li>
                                        <li><a className="scrollTo" data-scrollto="services" href="#">Our Services</a></li>
            ...
            <section className="baner" id="top">
                <div className="contaisdner">
                    <div className="row">
                        <div className="col-md-10 col-md-offset-1">
                            <div className="banner-sdscaption">
